...
<body>
    ...
    <div class="content">
        ...
        <!--Titlul articolului--><a href="view.php?id=<?php echo  $row['id_article'];?>" style="color:#000;" ><p style="paddind-left:30px;" class="title"><i><?php echo $row['title'];?></i></p></a> 
        
        
        <!--Continutul articolului--> <p><?php 
        
        echo $row['content'];
        ?></p>
        
        <p><a href="view.php?id=<?php echo  $row['id_article'];?>" class="detalii">Read more---></a></p>
        <hr>
        <?php
           }
