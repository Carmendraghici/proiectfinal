...
<body>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="active"><a href="tutoriale.php">Tutorials</a></li>
    ...
    <div class="content">
        ...
        <p class="title_video">
            ...
            ?>
            <i><a href="https://www.youtube.com/watch?time_continue=6&v=mmwzmVwIu8U&feature=emb_title;"><?php echo $row['title'];?></a></i>
            </p>
            <p class="description"><?php echo $row['description']?></p>
            <p><img src="<?php echo $row['img'];?>" width="300" height="200" ></p>
