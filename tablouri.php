...
<body>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="active"><a href="tablouri.php">Paintings</a></li>
    ...
    <?php 
          ...
          do{
              ...
              <p class="tablouri" >
                   ...
                   <b><?php echo $row['title'];?></a></b>
            </p>
            
            <p class="tablouri"><?php echo $row['description']?></p>
            <a  target ="_blank" href="http://localhost/proiect2php/www/<?php echo $row['poza'];?>"><img src="<?php echo $row['poza'];?>" style="float:center"  width="175" height="250" ></a>
